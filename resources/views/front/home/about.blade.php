<div class="wave-white-bottom bg-mild-yellow py-20" id="about">
    <p class="type-h1 md:text-center px-6 mb-12" data-usher>{{ trans('home.about.heading') }}</p>
    ...
    <div class="text-center my-20">
        <a href="{{ localUrl('/about-us') }}"
           class="hover:text-hms-navy type-a2 arrow-link-left">{!! trans('home.about.link') !!}</a>
    </div>
