...
export default {
    ...
    getters: {
        ...
        byId: state => id =>
            state.affiliates.find(affiliate => affiliate.id === parseInt(id))
    },
    ...
    actions: {
        fetchAffiliates({ commit }) {
            return new Promise((resolve, reject) => {
                axios
                    ...
                    .catch(() =>
                        reject({ message: "Unable to fetch affiliates." })
                    );
            });
        },
        ...
        fetchById(_, id) {
            return new Promise((resolve, reject) => {
                axios
                    ...
                    .catch(() =>
                        reject({ message: "Unable to fetch affiliate." })
                    );
            });
        },
        ...
        addAffiliate({ dispatch }, affiliate_data) {
            return new Promise((resolve, reject) => {
                axios
                    .post("/admin/api/affiliates", affiliate_data)
                    .then(({ data }) => {
        ...
        updateAffiliate({ dispatch }, { id, data }) {
            return new Promise((resolve, reject) => {
                axios
                    .post(`/admin/api/affiliates/${id}`, data)
                    .then(({ data }) => {
                        dispatch("fetchAffiliates").catch(notify.error);
                        resolve(data);
                    })
        ...
        publishAffiliate({ dispatch }, affiliate_id) {
            return new Promise((resolve, reject) => {
                axios
                    .post("/admin/api/published-affiliates", { affiliate_id })
                    .then(() => {
                        dispatch("fetchAffiliates").catch(notify.error);
                        resolve({
                            message: "The affiliate has been published"
                        });
                    })
                    .catch(() =>
                        reject({ message: "Unable to publish affiliate" })
                    );
            });
        },
        ...
        retractAffiliate({ dispatch }, affiliate_id) {
            return new Promise((resolve, reject) => {
                axios
                    .delete(`/admin/api/published-affiliates/${affiliate_id}`)
                    .then(() => {
                        dispatch("fetchAffiliates").catch(notify.error);
                        resolve({
                            message: "The affiliate has been retracted"
                        });
                    })
                    .catch(() =>
                        reject({ message: "Unable to retract affiliate" })
                    );
            });
        },
        ...
        deleteAffiliate({ dispatch }, affiliate_id) {
            return new Promise((resolve, reject) => {
                axios
                    .delete(`/admin/api/affiliates/${affiliate_id}`)
                    .then(() => {
                        dispatch("fetchAffiliates").catch(notify.error);
                        resolve({ message: "Affiliate has been deleted" });
                    })
                    .catch(() =>
                        reject({ message: "Unable to delete affiliate" })
                    );
            });
        }
    }
