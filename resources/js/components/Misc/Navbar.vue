<template>
    <div class="flex justify-between items-center bg-hms-navy pl-4 h-16">
        <div class="flex-1 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 196.6 23.65" class="h-4 text-mustard">
        ...
        <div class="flex justify-end items-center">
            <router-link v-if="is_admin" to="/affiliates" class="text-white hover:text-mustard font-bold px-4 mr-4 no-underline hover:underline">Affiliates</router-link>
            <router-link v-if="is_admin" to="/teachers" class="text-white hover:text-mustard font-bold px-4 mr-4 no-underline hover:underline">Teachers</router-link>
            <router-link v-if="is_admin" to="/subjects" class="text-white hover:text-mustard font-bold px-4 mr-4 no-underline hover:underline">Subjects</router-link>
            <router-link v-if="is_admin" to="/users" class="text-white hover:text-mustard font-bold px-4 mr-4 no-underline hover:underline">Users</router-link>
            <dropdown v-cloak
                      :name="username"
                ...
                <div slot="dropdown_content"
                    ...
                    <router-link to="/me/show"
                                 class="text-black no-underline hover:text-mustard pb-3 block">My Profile
                    </router-link>
                    <router-link to="/me/user-info"
                                 class="text-black no-underline hover:text-mustard pb-3 block">My User Info
                    </router-link>
                    <router-link to="/me/password/edit"
                                 class="text-black no-underline hover:text-mustard pb-3 block">Reset Password</router-link>
                    <button @click="logout" type="button" class="text-black hover:text-mustard">Logout</button>
                </div>
            </dropdown>
        </div>
    </div>
